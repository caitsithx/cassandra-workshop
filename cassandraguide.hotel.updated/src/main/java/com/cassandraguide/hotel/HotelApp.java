...
public class HotelApp {
	private static final Log LOG = LogFactory.getLog(HotelApp.class);
	...
	//use column slice to get from Super ColumnDescriptor
	public List<PointOfInterest> findPOIByHotel(String hotel) throws Exception {
		///query
